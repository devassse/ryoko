            ...
            <section className="main-level">
              ...
              <article className="main-content">
                <div className="header">
                  <div className="user-greatings">
                    <h2>
                      Hello <span>@Devasse</span>
                    </h2>
                    <p className="welcome-caption">
                      Welcome, Let's go and Explore the World!
                    </p>
                  </div>
                  <div className="select-country">
                    <select class="form-select" id="country" name="country">
                      <option value="">Search your destination</option>
                ...
                <div className="locations">
                  <div className="location-card">
                    <h3>Marrocos - Morrroco</h3>
                    <h5>110,000M Habitants</h5>
                    <h6>23ºC now</h6>
                  </div>
                  <div className="location-card">
                    <h3>Emirates - Abudabi</h3>
                    <h5>110,000M Habitants</h5>
                    <h6>23ºC now</h6>
                  </div>
                  <div className="location-card">
              ...
              <aside className="aside-right-user-info">
                ...
                <div className="my-favorites">
                  <h4>My favorites</h4>
                  <span className="caption">Last vizited and Loved by me</span>
                  <div className="favorites">
                    <div className="favorite">
                      <span>Mozambique Island</span>
